...
const ORBIT_PATTERN_ROTATION_SPACING: int = 60
...
# OUT-OF-SCOPE implement enum/array for on-contact actions
...
const STYLE_DATA = {
	...
	Style.SPLIT_SHOT : {
		...
		DataType.SHOT_STATIONARY_BONUS		: 1.0,#0.95,
	...
	Style.TRIPLE_BURST_SHOT : {
		...
		DataType.PROJECTILE_FLIGHT_SPEED	: 1500,
	...
	Style.SNIPER_SHOT : {
		...
		DataType.SHOT_USE_COOLDOWN			: 1.4,
		DataType.SHOT_STATIONARY_BONUS		: 1.0,#0.5,
		...
		DataType.PROJECTILE_FLIGHT_SPEED	: 2500,
		DataType.PROJECTILE_SPEED_INHERIT	: 0.4,
		DataType.PROJECTILE_SHOT_VARIANCE	: 0.01,
	},
	...
	Style.VORTEX_SHOT : {
		...
		DataType.PROJECTILE_SPRITE_COLOUR	: Color.whitesmoke,
		DataType.PROJECTILE_SPRITE_ROTATE	: 12,
		...
		DataType.SHOT_STATIONARY_BONUS		: 1.0,
		DataType.AI_MIN_USE_RANGE			: GlobalVariables.RangeGroup.MELEE,
		DataType.AI_MAX_USE_RANGE			: GlobalVariables.RangeGroup.NEAR,
		...
		DataType.PROJECTILE_SPAWN_PATTERN	: SpawnPattern.SPREAD,
		DataType.PROJECTILE_SPAWN_DELAY		: 0.15,
		DataType.USE_SNIPER_AIM_LINE		: false,
		DataType.PROJECTILE_COUNT			: 1,
	...
	Style.WIND_SCYTHE : {
		...
		DataType.WEAPON_ICON_SPRITE			: GlobalReferences.sprite_weapon_wind_scythe,
		DataType.PROJECTILE_SPRITE_TYPE		: GlobalReferences.sprite_projectile_scythe,
		DataType.PROJECTILE_SPRITE_COLOUR	: Color.pink,
		DataType.PROJECTILE_SPRITE_ROTATE	: 64,
		DataType.PROJECTILE_PARTICLES		: ProjectileParticles.NONE,
		DataType.SHOT_AUDIO_STYLE			: AudioStyle.ON_FIRE,
		DataType.SHOT_SOUND_EFFECT			: ShotSound.NONE,
		DataType.SHOT_SURGE_EFFECT			: SpawnSurgeEffect.NONE,
		...
		DataType.BASE_DAMAGE				: 30,
		DataType.PROJECTILE_SIZE			: 0.35,
		DataType.PROJECTILE_MAX_MOVE_TICKS	: 2000,
		DataType.PROJECTILE_MAX_RANGE		: 100,
		DataType.PROJECTILE_MAX_LIFESPAN	: 0.4,
		DataType.PROJECTILE_OFFSCREEN_SPAN	: 0.2,
		DataType.PROJECTILE_MOVE_PATTERN	: GlobalVariables.ProjectileMovement.DIRECT,
		DataType.PROJECTILE_SPAWN_PATTERN	: SpawnPattern.SERIES,
		DataType.PROJECTILE_SPAWN_DELAY		: 0.15,
		DataType.USE_SNIPER_AIM_LINE		: true,
		DataType.PROJECTILE_COUNT			: 2,
		DataType.PROJECTILE_FLIGHT_SPEED	: 1000,
		DataType.PROJECTILE_SPEED_INHERIT	: 0.0,
		DataType.PROJECTILE_SHOT_VARIANCE	: 0.75,
	},
	
	Style.BOLT_LANCE : {
		"Name" 								: "Bolt Lance",
		DataType.DESCRIPTION_STRINGREF		: GlobalReferences.DESC_NONE,
		DataType.WEAPON_ICON_SPRITE			: GlobalReferences.sprite_weapon_bolt_lance,
		DataType.PROJECTILE_SPRITE_TYPE		: GlobalReferences.sprite_projectile_bolt_lance,
		DataType.PROJECTILE_SPRITE_COLOUR	: Color.yellow,
		...
		DataType.PROJECTILE_MOVE_PATTERN	: GlobalVariables.ProjectileMovement.DIRECT,
		DataType.PROJECTILE_SPAWN_PATTERN	: SpawnPattern.SERIES,
		DataType.PROJECTILE_SPAWN_DELAY		: 0.2,
		DataType.USE_SNIPER_AIM_LINE		: true,
		DataType.PROJECTILE_COUNT			: 1,
		DataType.PROJECTILE_FLIGHT_SPEED	: 500,
		DataType.PROJECTILE_SPEED_INHERIT	: 0.0,
	...
	Style.BASIC_SHOT : {
		...
		DataType.USE_SNIPER_AIM_LINE		: false,
		DataType.PROJECTILE_COUNT			: 1,
		DataType.PROJECTILE_FLIGHT_SPEED	: 650,
		DataType.PROJECTILE_SPEED_INHERIT	: 0.2,
		DataType.PROJECTILE_SHOT_VARIANCE	: 0.05,
	},
	...
	Style.FLAMETHROWER : {
		...
		DataType.SHOT_SURGE_EFFECT			: SpawnSurgeEffect.NONE,
		DataType.SHOT_AIM_TYPE				: AimType.FREE_AIM,
		DataType.SHOT_USE_COOLDOWN			: 0.01,
		DataType.SHOT_STATIONARY_BONUS		: 1.00,
		DataType.AI_MIN_USE_RANGE			: GlobalVariables.RangeGroup.MELEE,
		DataType.AI_MAX_USE_RANGE			: GlobalVariables.RangeGroup.NEAR,
		DataType.BASE_DAMAGE				: 2,
		DataType.PROJECTILE_SIZE			: 0.5,
		DataType.PROJECTILE_MAX_MOVE_TICKS	: 4000,
		DataType.PROJECTILE_MAX_RANGE		: 200,
		DataType.PROJECTILE_MAX_LIFESPAN	: 0.2,
		DataType.PROJECTILE_OFFSCREEN_SPAN	: 1.0,
		DataType.PROJECTILE_MOVE_PATTERN	: GlobalVariables.ProjectileMovement.DIRECT,
		DataType.PROJECTILE_SPAWN_PATTERN	: SpawnPattern.SERIES,
